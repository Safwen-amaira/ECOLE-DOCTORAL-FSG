...
const FormationPedaModel = (props) => {
                    ...
                    <div className='container'>
                        ...
                        <div style={{ marginLeft: '10px' }}>
                            ...
                            <p> {formation.chercheur ? (
                                ...
                                <p><strong>année universitaire :</strong> {formation.annee_universitaire}</p>
                                <p><strong>semestre:</strong> {formation.semestre}</p>
                                ...
                                {formation.file && (
                                    ...
                                    <FaTrash
                                        ...
                                        size={15}
                                        onClick={event => handleDeletePeda(event, formation.id)}
                                    /> <span style={{ marginLeft: "20px" }}></span>
                                    <FaEdit
                                        className="edit-icon"
                                        size={15}
                                        onClick={event => handleUpdatePeda(event, formation)}
                                    />
...
export default FormationPedaModel
