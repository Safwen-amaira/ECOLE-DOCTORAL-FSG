...
const ListUniteRattache = () => {
    ...
    useEffect(() => {
        const doFilter = () => {
            const filtered = Labos.filter(lb => lb.type ==='UniteR');
    ...
    return (
        ...
        <br/><br/><br/><br/><br/>
            <div className="vstack gap-3">
                ...
                <div > <h2 className="alert alert-success"> <center>Liste des Unités Rattachées</center></h2></div>
...
export default ListUniteRattache
