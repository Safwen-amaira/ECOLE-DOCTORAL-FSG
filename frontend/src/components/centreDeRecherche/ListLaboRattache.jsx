...
const ListLaboRattache = () => {
    ...
    useEffect(() => {
        const doFilter = () => {
            const filtered = Labos.filter(lb => lb.type ==='LaboR');
    ...
    return (
        ...
        <br/><br/><br/><br/><br/>
            <div className="vstack gap-3">
                ...
                <div > <h2 className="alert alert-success"> <center>Liste des laboratoires  Rattachés</center></h2></div>
...
export default ListLaboRattache
