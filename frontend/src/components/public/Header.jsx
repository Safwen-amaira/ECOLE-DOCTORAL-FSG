    ...
    <div className='container'>
      <div className='First-Level'>
        ...
        <div className='Tnflag-container'>
          <img style={{ height: '60px', width: '300px',marginTop:'25px' }} src={EDSENLogo} alt='tunisian flag' className='Tnflag' />
      ...
      <div className='Third-Level'>
        <Slider  {...settings} autoplay={true} autoplaySpeed={3000}> 
          {images.map(image => (
            <div key={image.id}>
            <img src={`http://127.0.0.1:8000${image.image}`} height={420}  className='facultePIC' alt={image.title} />
            </div>
          ))}
        </Slider>
        <div className='forPcOrBigScreenOnly'>
        <div className='Third-Level'>
        
          <div className='forPcOrBigScreenOnly'>

            <Link to='/login'>
              <button className='LoginButtonForHeaderS' >S'identifier</button>
            </Link>
            <select style={{ position: "absolute", marginTop: "-22%", width: "100px", marginLeft: "73.5%", height: "30px", color: "white", background: " rgb(43, 43, 96)" }} >
              <option value="Frensh" style={{ color: "white", background: " rgb(43, 43, 87)" }}>Français</option>
              <option value="english" style={{ color: "white", background: " rgb(43, 43, 87)" }}>English</option>
              <option value="arab" style={{ color: "white", background: " rgb(43, 43, 87)" }}>Arabe</option>
            </select>
          </div>
        </div>
      </div>
